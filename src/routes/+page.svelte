    ...
    <TabToggler bind:state></TabToggler>
        ...
        <div class="bodyContent">
            <div class="widgetList">
                ...
                <div><HomeWidget where = 'list' id=1 enabled = {widgetControl[1]} widgType = "prerun" status = 'closed' data = ''></HomeWidget></div>
                <div><HomeWidget where = 'list' id=2 enabled = {widgetControl[2]} widgType = "experience" status = 'closed' data = 320></HomeWidget></div>
                <div><HomeWidget where = 'list' id=3 enabled = {widgetControl[3]} widgType = "dist" status = 'closed' data = {dist_sum}></HomeWidget></div>
                <div><HomeWidget where = 'list' id=4 enabled = {widgetControl[4]} widgType = "pace" status = 'closed' data = {pace_avg}></HomeWidget></div>
                <div><HomeWidget where = 'list' id=5 enabled = {widgetControl[5]} widgType = "awards" status = 'closed' data = "Expand to See More"></HomeWidget></div>
                <div><HomeWidget where = 'list' id=6 enabled = {widgetControl[6]} widgType = "records" status = 'closed' data = "Expand to See More"></HomeWidget></div>
                <div><HomeWidget where = 'list' id=7 enabled = {widgetControl[7]} widgType = "lastrun" status = 'closed' data = {filtered_runs.date}></HomeWidget></div>
            </div>
        </div>
        ...
        {:else if (state == 'run')}
            <div class="bodyContent">
                ...
                <div class="widgetList">
                    <div><RunWidget widgType = "distance" data = "0.00"></RunWidget></div>
                    <div><RunWidget widgType = "pace" data = "0.00"></RunWidget></div>
                    <div><RunWidget widgType = "timer" data = "0:00"></RunWidget></div>
...
<!-- Home -->
        ...
        <div class="bodyContentHome">
            ...
            <div class="homebody">
                ...
                <div><HomeWidget where = 'home' id=1 enabled = {widgetControl[1]} widgType = "prerun" status = 'closed' data = ''></HomeWidget></div>
                <div><HomeWidget where = 'home' id=2 enabled = {widgetControl[2]} widgType = "experience" status = 'closed' data = 320></HomeWidget></div>
                <div><HomeWidget where = 'home' id=3 enabled = {widgetControl[3]} widgType = "dist" status = 'closed' data = {dist_sum}></HomeWidget></div>
                <div><HomeWidget where = 'home' id=4 enabled = {widgetControl[4]} widgType = "pace" status = 'closed' data = {pace_avg}></HomeWidget></div>
                <div><HomeWidget where = 'home' id=5 enabled = {widgetControl[5]} widgType = "awards" status = 'closed' data = "Expand to See More"></HomeWidget></div>
                <div><HomeWidget where = 'home' id=6 enabled = {widgetControl[6]} widgType = "records" status = 'closed' data = "Expand to See More"></HomeWidget></div>
                <div><HomeWidget where = 'home' id=7 enabled = {widgetControl[7]} widgType = "lastrun" status = 'closed' data = {filtered_runs.date}></HomeWidget></div>
